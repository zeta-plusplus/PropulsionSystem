...
model Turboshaft
  ...
  Modelica.Fluid.Sensors.Pressure pressure_Fl070(redeclare package Medium = engineAir) annotation(
    Placement(visible = true, transformation(origin = {170, 28}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Fluid.Sensors.Pressure pressure_Fl090(redeclare package Medium = engineAir) annotation(
    Placement(visible = true, transformation(origin = {190, 44}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
...
equation
  ...
  annotation(
    ...
    Diagram(coordinateSystem(extent = {{-100, -100}, {280, 100}})),
