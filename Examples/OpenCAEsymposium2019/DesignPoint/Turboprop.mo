...
model Turboprop
  ...
  Modelica.Blocks.Sources.Ramp ramp_TIT(duration = 10, height = 100, offset = 1600, startTime = 40) annotation(
...
equation
  connect(division1.y, setDependent1.dependent_in) annotation(
    Line(points = {{261, 22}, {267, 22}, {267, 22}, {267, 22}}, color = {0, 0, 127}));
  ...
  connect(Nzl070.Fg_out, add1.u1) annotation(
    Line(points = {{215, 10}, {226, 10}, {226, -14}, {238, -14}}, color = {0, 0, 127}));
  connect(pressure2.p, division1.u1) annotation(
    Line(points = {{201, 28}, {237, 28}}, color = {0, 0, 127}));
  connect(Trb046.port_2, pressure2.port) annotation(
    Line(points = {{170, 18}, {190, 18}}, color = {0, 127, 255}));
  connect(pressure1.p, division1.u2) annotation(
    Line(points = {{225, 44}, {229, 44}, {229, 16}, {237, 16}}, color = {0, 0, 127}));
  ...
  connect(ShLP.flange_b, Trb046.flange_1) annotation(
    Line(points = {{130, -80}, {136, -80}, {136, 10}, {150, 10}}));
  connect(Duct045.port_2, Trb046.port_1) annotation(
    Line(points = {{130, 18}, {150, 18}}, color = {0, 127, 255}));
