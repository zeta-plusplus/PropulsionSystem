...
model arr_us_const_p_00_ex01
  ...
  PropulsionSystem.Utilities.arr_us_const_p_00 arr_us(redeclare package Medium = engineAir) annotation(
    Placement(visible = true, transformation(origin = {20, 3.55271e-15}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
equation
  connect(const_Xi_fluidState_1.y, arr_us.u_Xi) annotation(
    Line(points = {{-38, -60}, {-12, -60}, {-12, -16}, {-2, -16}, {-2, -16}}, color = {0, 0, 127}, thickness = 0.5));
  connect(ramp_p.y, arr_us.u_p) annotation(
    Line(points = {{-38, -20}, {-20, -20}, {-20, -8}, {-2, -8}, {-2, -8}}, color = {0, 0, 127}));
  connect(const_sLower.y, arr_us.u_sLower) annotation(
    Line(points = {{-38, 10}, {-18, 10}, {-18, 8}, {-2, 8}, {-2, 8}}, color = {0, 0, 127}));
  connect(const_sUpper.y, arr_us.u_sUpper) annotation(
    Line(points = {{-38, 40}, {-10, 40}, {-10, 16}, {-2, 16}, {-2, 16}}, color = {0, 0, 127}));
  annotation(
