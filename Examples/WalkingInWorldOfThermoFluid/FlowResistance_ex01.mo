...
equation
  ...
  connect(boundary.ports[1], volume.ports[1]) annotation(
    Line(points = {{-40, 50}, {-24, 50}, {-24, 50}, {-22, 50}}, color = {0, 127, 255}, thickness = 0.5));
  connect(volume.ports[2], pipe.port_a) annotation(
    Line(points = {{-22, 50}, {0, 50}, {0, 50}, {0, 50}}, color = {0, 127, 255}));
...
annotation(
    ...
    __OpenModelica_simulationFlags(lv = "LOG_STATS", outputFormat = "mat", s = "dassl"));end FlowResistance_ex01;
