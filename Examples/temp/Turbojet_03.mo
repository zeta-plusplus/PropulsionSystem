...
equation
  connect(inlet1.Fram_out, perf001.u_Fram) annotation(
    Line(points = {{-23, -14}, {-16, -14}, {-16, -46}, {170, -46}}, color = {0, 0, 127}));
  ...
  connect(inlet1.port_2, Cmp.port_1) annotation(
    Line(points = {{-20, -2}, {-10, -2}, {-10, -2}, {-10, -2}}, color = {0, 127, 255}));
  ...
  connect(Comb.y_m_flow_fuel, perf001.u_m_flow_fuel) annotation(
    Line(points = {{38, 2}, {38, 2}, {38, -58}, {170, -58}, {170, -58}}, color = {0, 0, 127}));
  ...
  annotation(
    ...
    Diagram(coordinateSystem(extent = {{-100, -60}, {200, 100}}, initialScale = 0.1), graphics = {Text(origin = {-8, 97}, extent = {{-18, 2}, {4, -2}}, textString = "Combustor")}),
