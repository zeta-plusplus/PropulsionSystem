...
model PistonCylinderIdealOttoMV00_ex03
  ...
  Modelica.Blocks.Sources.Ramp ramp_fracFuel(duration = 10, height = -0.01, offset = 0.02, startTime = 10) annotation(
    Placement(visible = true, transformation(origin = {-70, -10}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Sources.Ramp ramp_p1(duration = 10, height = 20 * 1000, offset = 101.325 * 1000, startTime = 10) annotation(
