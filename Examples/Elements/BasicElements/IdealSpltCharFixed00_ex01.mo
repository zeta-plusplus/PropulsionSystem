...
model IdealSpltCharFixed00_ex01
  ...
  PropulsionSystem.BaseClasses.BasicElements.IdealSplitterBase00 Splt(redeclare package Medium = engineAir) annotation(
...
equation
  connect(Splt.port_3, Nzl.port_1) annotation(
    Line(points = {{20, -26}, {32, -26}, {32, 18}, {60, 18}}, color = {0, 127, 255}));
  connect(Splt.port_2, Nzl1.port_1) annotation(
    Line(points = {{20, -30}, {36, -30}, {36, -22}, {60, -22}}, color = {0, 127, 255}));
  connect(pressure1.port, Splt.port_1) annotation(
    Line(points = {{-50, -30}, {0, -30}}, color = {0, 127, 255}));
