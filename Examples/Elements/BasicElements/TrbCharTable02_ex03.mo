...
model TrbCharTable02_ex03
  ...
  PropulsionSystem.Elements.BasicElements.TrbCharTable02 Trb(redeclare package Medium = engineAir, printCmd = false, switchDetermine_PR = PropulsionSystem.Types.switches.switchHowToDetVar.param, switch_calcOnlyDes = true, use_tableFile_Wc = true, use_tableFile_eff = true) annotation(
