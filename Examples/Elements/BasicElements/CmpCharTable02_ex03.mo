...
model CmpCharTable02_ex03
  ...
  PropulsionSystem.Elements.BasicElements.CmpCharTable02 Cmp(redeclare package Medium = engineAir, printCmd = false, switch_calcOnlyDes = true, use_tableFile_PR = true, use_tableFile_Wc = true, use_tableFile_eff = true) annotation(
