...
model TurboJet001_test_CompressorDesPt00_01
  ...
  PropulsionSystem.Elements.BasicElements.CompressorDesPt00 Cmp(redeclare package Medium = engineAir) annotation(
    Placement(visible = true, transformation(origin = {0, 10}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
equation
  connect(Cmp.flange_2, constrain_Nmech1.flange_a) annotation(
    Line(points = {{10, 10}, {14, 10}, {14, -20}, {20, -20}, {20, -20}}));
  connect(Cmp.port_2, Duct030.port_1) annotation(
    Line(points = {{10, 18}, {20, 18}, {20, 18}, {20, 18}}, color = {0, 127, 255}));
  connect(Inlt010.port_2, Cmp.port_1) annotation(
    Line(points = {{-20, 18}, {-10, 18}, {-10, 18}, {-10, 18}}, color = {0, 127, 255}));
...
end TurboJet001_test_CompressorDesPt00_01;
