...
model Turboshaft_ex01
  ...
  Modelica.Blocks.Math.UnitConversions.To_rpm to_rpm annotation(
    Placement(visible = true, transformation(origin = {-48, -130}, extent = {{-10, -10}, {10, 10}}, rotation = 270)));
  Modelica.Mechanics.Rotational.Sensors.SpeedSensor speedSensor annotation(
    Placement(visible = true, transformation(origin = {-48, -90}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  ...
  Modelica.Blocks.Math.UnitConversions.From_rpm from_rpm1 annotation(
    Placement(visible = true, transformation(origin = {-130, -80}, extent = {{10, -10}, {-10, 10}}, rotation = 180)));
