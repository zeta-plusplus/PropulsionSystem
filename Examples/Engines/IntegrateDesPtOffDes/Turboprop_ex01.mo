...
model Turboprop_ex01
  ...
  Modelica.Blocks.Sources.Ramp ramp1(duration = 10, height = 100, offset = 2000, startTime = 30) annotation(
  ...
  PropulsionSystem.Elements.BasicElements.PropActDiskCharFixed01 Prop(redeclare package Medium = engineAir, printCmd = false) annotation(
    Placement(visible = true, transformation(origin = {-180, -80}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
  PropulsionSystem.Sources.NmechAtDesignPoint01 NmechDes1(NmechDes_paramInput = 2000)  annotation(
    Placement(visible = true, transformation(origin = {-90, -80}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
equation
  connect(NmechDes1.flange_2, Trb1.flange_1) annotation(
    Line(points = {{-80, -80}, {80, -80}, {80, -80}, {80, -80}}));
  ...
  connect(Trb.port_2, Trb1.port_1) annotation(
    Line(points = {{60, 36}, {80, 36}, {80, -64}}, color = {0, 127, 255}));
  connect(Nzl.port_2, temperature1.port) annotation(
    Line(points = {{180, -64}, {180, 160}}, color = {0, 127, 255}));
  connect(pressureRatio1.port_a, Nzl.port_1) annotation(
    Line(points = {{140, 16}, {140, -64}}, color = {0, 127, 255}));
  connect(pressureRatio1.port_b, Nzl.port_2) annotation(
    Line(points = {{160, 16}, {180, 16}, {180, -64}}, color = {0, 127, 255}));
  ...
  connect(Constraint2.u_variable, pressureRatio1.p_ratio) annotation(
    Line(points = {{150, 40}, {150, 40}, {150, 26}, {150, 26}}, color = {0, 0, 127}));
  connect(from_rpm1.u, ramp1.y) annotation(
    Line(points = {{-38, -150}, {-32, -150}, {-32, -150}, {-30, -150}}, color = {0, 0, 127}));
  connect(Flt2Fluid.port_amb4sink, temperature1.port) annotation(
    Line(points = {{-240, 56}, {-240, 160}, {180, 160}}, color = {0, 127, 255}));
  connect(Flt2Fluid.port_inlet, Inlt.port_1) annotation(
    Line(points = {{-220, 36}, {-200, 36}, {-200, 36}, {-180, 36}, {-180, 36}, {-180, 36}, {-180, 36}, {-180, 36}}, color = {0, 127, 255}));
  connect(Flt2Fluid.y_V_inf, Inlt.u_V_infini) annotation(
    Line(points = {{-218, 20}, {-215, 20}, {-215, 20}, {-212, 20}, {-212, 12}, {-174, 12}, {-174, 14}, {-174, 14}, {-174, 12}}, color = {0, 0, 127}));
  ...
  connect(MassFlowDes.port_2, Cmp.port_1) annotation(
    Line(points = {{-110, 36}, {-104, 36}, {-104, 36}, {-98, 36}, {-98, 36}, {-99, 36}, {-99, 36}, {-100, 36}}, color = {0, 127, 255}));
  ...
  connect(NmechDes.flange_2, Trb.flange_1) annotation(
    Line(points = {{-20, 20}, {20, 20}, {20, 20}, {20, 20}}));
  connect(temperature.port, Trb.port_1) annotation(
    Line(points = {{20, 60}, {20, 60}, {20, 36}, {20, 36}, {20, 36}, {20, 36}}, color = {0, 127, 255}));
  connect(Cmp.port_2, Comb.port_1) annotation(
    Line(points = {{-60, 36}, {-60, 36}, {-60, 60}, {-40, 60}, {-40, 60}}, color = {0, 127, 255}));
  connect(VarBySolver.y_independent, boundary.m_flow_in) annotation(
    Line(points = {{-89, 120}, {-83, 120}, {-83, 98}, {-71, 98}, {-71, 98}, {-71, 98}, {-71, 98}}, color = {0, 0, 127}));
  ...
  connect(Comb.port_2, temperature.port) annotation(
    Line(points = {{-0.5, 60.2}, {20, 60.2}}, color = {0, 127, 255}));
  connect(Constraint.u_variable, temperature.T) annotation(
    Line(points = {{30, 89}, {30, 81.5}, {30, 81.5}, {30, 70}, {28.5, 70}, {28.5, 70}, {27, 70}}, color = {0, 0, 127}));
  connect(ramp_TIT.y, Constraint.u_targetValue) annotation(
    Line(points = {{30, 119}, {30, 111}}, color = {0, 0, 127}));
  annotation(
