...
model Turbofan_lowBPR_ex01
  ...
  PropulsionSystem.Elements.BasicElements.DuctCharFixed00 Duct(redeclare package Medium = engineAir) annotation(
    Placement(visible = true, transformation(origin = {104, 120}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
equation
  connect(SpltDesPt.port_3, Duct.port_1) annotation(
    Line(points = {{-132, 104}, {-128, 104}, {-128, 120}, {94, 120}, {94, 120}}, color = {0, 127, 255}));
