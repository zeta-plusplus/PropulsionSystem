...
model TurboProp001_002
  ...
  PropulsionSystem.Elements.DetailedModels.Propeller1dAeroTip propeller1dAeroTip1(redeclare package Medium = engineAir, alpha_CdpMinDes(displayUnit = ""), lAxial_def = 0.05, rHub_1_def = 0.1, rHub_2_def = 0.1, rTip_1_def = 0.5, rTip_2_def = 0.5) annotation(
  ...
  Modelica.Blocks.Sources.Constant const1(k = 30 * Modelica.Constants.pi / 180)  annotation(
    Placement(visible = true, transformation(origin = {30, -90}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
equation
  connect(const1.y, propeller1dAeroTip1.u_bladeAngle) annotation(
    Line(points = {{30, -100}, {30, -100}, {30, -118}, {30, -118}}, color = {0, 0, 127}));
  connect(ShProp.flange_b, idealGear1.flange_a) annotation(
    Line(points = {{80, -140}, {120, -140}, {120, -140}, {120, -140}}));
