...
equation
  ...
  connect(Cmp120.flange_2, Cmp020.flange_1) annotation(
    Line(points = {{-160, 100}, {-152, 100}, {-152, 20}, {-140, 20}}));
  ...
  connect(Cmp020.flange_2, Trb049.flange_1) annotation(
    Line(points = {{-100, 20}, {-88, 20}, {-88, 80}, {200, 80}, {200, 80}}));
  connect(Inlt.port_2, Cmp020.port_1) annotation(
    Line(points = {{-220, 36}, {-140, 36}}, color = {0, 127, 255}));
  connect(Cmp020.port_2, massFlowRate2.port_a) annotation(
    Line(points = {{-100, 36}, {-70, 36}, {-70, -34}, {-50, -34}}, color = {0, 127, 255}));
