...
model Turbofan_ex02
  ...
  PropulsionSystem.Elements.BasicElements.CmpCharTable00 Cmp020(redeclare package Medium = engineAir, NmechDes_paramInput = 3000, PRdes_paramInput = 2, m_flow_des_1_paramInput = 10, use_tableFile_PR = true, use_tableFile_Wc = true, use_tableFile_eff = true)  annotation(
    Placement(visible = true, transformation(origin = {-168, 20}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
  ...
  PropulsionSystem.Elements.BasicElements.DuctCharFixed00 Duct024(redeclare package Medium = engineAir) annotation(
    Placement(visible = true, transformation(origin = {-70, -34}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
equation
  connect(Duct024.port_2, Cmp025.port_1) annotation(
    Line(points = {{-60, -34}, {-40, -34}, {-40, -34}, {-40, -34}}, color = {0, 127, 255}));
  connect(massFlowRate2.port_b, Duct024.port_1) annotation(
    Line(points = {{-100, -34}, {-80, -34}, {-80, -34}, {-80, -34}}, color = {0, 127, 255}));
  connect(Cmp025.flange_2, Trb041.flange_1) annotation(
    Line(points = {{0, -50}, {120, -50}}));
  connect(Cmp025.port_2, Comb036.port_1) annotation(
    Line(points = {{0, -34}, {0, -10}, {50, -10}}, color = {0, 127, 255}));
  connect(LossRotMech.flange_2, Trb049.flange_1) annotation(
    Line(points = {{-40, 80}, {200, 80}, {200, 80}, {200, 80}}));
  connect(Cmp020.flange_2, LossRotMech.flange_1) annotation(
    Line(points = {{-148, 20}, {-126, 20}, {-126, 80}, {-60, 80}, {-60, 80}}));
  connect(Cmp120.flange_2, LossRotMech.flange_1) annotation(
    Line(points = {{-160, 80}, {-60, 80}, {-60, 80}, {-60, 80}}));
  connect(massFlowRate1.m_flow, getBPR.u1) annotation(
    Line(points = {{-130, 147}, {-130, 156}, {-82, 156}}, color = {0, 0, 127}));
  connect(limiter1.y, getBPR.u2) annotation(
    Line(points = {{-110, 11}, {-110, 144}, {-82, 144}}, color = {0, 0, 127}));
  connect(Cmp120.port_2, massFlowRate1.port_a) annotation(
    Line(points = {{-160, 96}, {-150, 96}, {-150, 136}, {-140, 136}}, color = {0, 127, 255}));
  connect(massFlowRate1.port_b, Nzl170.port_1) annotation(
    Line(points = {{-120, 136}, {120, 136}}, color = {0, 127, 255}));
  connect(Cmp020.port_2, massFlowRate2.port_a) annotation(
    Line(points = {{-148, 36}, {-134, 36}, {-134, -34}, {-120, -34}}, color = {0, 127, 255}));
  connect(Inlt.port_2, Cmp020.port_1) annotation(
    Line(points = {{-220, 36}, {-188, 36}}, color = {0, 127, 255}));
