...
model Turbojet_ex01
  ...
  FluidSystemComponents.Utilities.VariableBySolver VarBySolver annotation(
    Placement(visible = true, transformation(origin = {194, 0}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  ...
  Modelica.Blocks.Sources.Ramp ramp_Trb_eff(duration = 10, height = 0, offset = 0.8, startTime = 30) annotation(
    Placement(visible = true, transformation(origin = {280, -160}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
equation
  connect(ramp_Trb_eff.y, Trb.u_eff) annotation(
    Line(points = {{280, -148}, {280, -148}, {280, -92}, {280, -92}}, color = {0, 0, 127}));
  ...
  connect(ramp_Cmp_PR.y, Cmp.u_PR) annotation(
    Line(points = {{112, -118}, {112, -118}, {112, -96}, {112, -96}}, color = {0, 0, 127}));
  ...
  connect(Comb.y_m_flow_fuel, Perf.u_m_flow_fuel) annotation(
    Line(points = {{226.5, -58}, {226.5, -248}, {398, -248}}, color = {0, 0, 127}));
  ...
  connect(VarBySolver.y_independent, Comb.u_m_flow_fuel) annotation(
    Line(points = {{194, -11}, {194, -16}, {194.5, -16}, {194.5, -22}}, color = {0, 0, 127}));
  connect(Inlt.y_FdRam, Perf.u_Fram) annotation(
    Line(points = {{74, -88}, {86, -88}, {86, -236}, {398, -236}, {398, -236}}, color = {0, 0, 127}));
  connect(Nzl.y_Fg, Perf.u_Fg) annotation(
    Line(points = {{370, -80}, {390, -80}, {390, -232}, {399, -232}}, color = {0, 0, 127}));
  ...
  connect(ramp_Nmech.y, from_rpm1.u) annotation(
    Line(points = {{170, -178}, {170, -178}, {170, -172}, {170, -172}}, color = {0, 0, 127}));
  connect(from_rpm1.y, Constraint1.u_targetValue) annotation(
    Line(points = {{170, -148}, {170, -148}, {170, -142}, {170, -142}}, color = {0, 0, 127}));
  connect(ramp_m_flow_inlet.y, Constraint.u_targetValue) annotation(
    Line(points = {{10, -158}, {10, -158}, {10, -142}, {10, -142}}, color = {0, 0, 127}));
  ...
  connect(speedSensor1.w, Constraint1.u_variable) annotation(
    Line(points = {{170, -101}, {170, -101}, {170, -117}, {170, -117}}, color = {0, 0, 127}));
