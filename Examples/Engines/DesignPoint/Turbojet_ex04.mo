...
model Turbojet_ex04
  ...
  PropulsionSystem.Elements.BasicElements.CombCharFixed02 Comb(redeclare package Medium = engineAir) annotation(
    Placement(visible = true, transformation(origin = {210, -40}, extent = {{-20, -16}, {20, 16}}, rotation = 0)));
...
equation
  ...
  connect(boundary.ports[1], Comb.port_fuel) annotation(
    Line(points = {{180, -10}, {194, -10}, {194, -24}}, color = {0, 127, 255}));
  connect(VarBySolver.y_independent, boundary.m_flow_in) annotation(
    Line(points = {{141, 80}, {153, 80}, {153, -2}, {160, -2}}, color = {0, 0, 127}));
  connect(ramp_Tfuel.y, boundary.T_in) annotation(
    Line(points = {{141, 50}, {149.5, 50}, {149.5, -6}, {158, -6}}, color = {0, 0, 127}));
  connect(Comb.y_m_flow_fuel, Perf.u_m_flow_fuel) annotation(
    Line(points = {{226, -58}, {226, -58}, {226, -258}, {400, -258}, {400, -258}}, color = {0, 0, 127}));
  connect(Comb.port_2, temperature040.port) annotation(
    Line(points = {{230, -40}, {250, -40}, {250, -40}, {250, -40}}, color = {0, 127, 255}));
  connect(Duct030.port_2, Comb.port_1) annotation(
    Line(points = {{180, -40}, {190, -40}, {190, -40}, {190, -40}}, color = {0, 127, 255}));
