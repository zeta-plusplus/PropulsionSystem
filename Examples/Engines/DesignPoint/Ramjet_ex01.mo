...
model Ramjet_ex01
  ...
  Modelica.Blocks.Sources.Constant const_TtCombOut(k = 1600) annotation(
...
equation
  ...
  connect(temperature.port, Duct1.port_1) annotation(
    Line(points = {{200, -4}, {240, -4}}, color = {0, 127, 255}));
  connect(Duct.port_2, Comb.port_1) annotation(
    Line(points = {{120, -4}, {140, -4}}, color = {0, 127, 255}));
  connect(Inlt.port_2, Duct.port_1) annotation(
    Line(points = {{60, -4}, {100, -4}}, color = {0, 127, 255}));
  connect(const_TtCombOut.y, Constraint1.u_targetValue) annotation(
