...
model Turbofan_ex01
  ...
  PropulsionSystem.Elements.BasicElements.CmpCharFixed00 Cmp025(redeclare package Medium = engineAir, switchDetermine_PR = PropulsionSystem.Types.switches.switchHowToDetVar.viaRealInput, use_u_eff = true) annotation(
  ...
  PropulsionSystem.Elements.BasicElements.DuctCharFixed00 Duct055(redeclare package Medium = engineAir) annotation(
    Placement(visible = true, transformation(origin = {348, -26}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ...
  Modelica.Blocks.Sources.Ramp ramp_Cmp025_PR(duration = 10, height = 10, offset = 10, startTime = 30) annotation(
  ...
  PropulsionSystem.Elements.BasicElements.CmpCharFixed00 Cmp020(redeclare package Medium = engineAir, PRdes_paramInput = 2) annotation(
  ...
  Modelica.Blocks.Sources.Ramp ramp_Cmp120_PR(duration = 10, height = 0.8, offset = 1.1, startTime = 10) annotation(
    Placement(visible = true, transformation(origin = {-162, 60}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
  Modelica.Blocks.Sources.Ramp ramp_Cmp120_eff(duration = 10, height = 0, offset = 0.8, startTime = 30) annotation(
...
equation
  ...
  connect(Trb049.port_2, Duct055.port_1) annotation(
    Line(points = {{320, -16}, {329, -16}, {329, -26}, {338, -26}}, color = {0, 127, 255}));
  ...
  connect(Duct055.port_2, Nzl070.port_1) annotation(
    Line(points = {{358, -26}, {380, -26}}, color = {0, 127, 255}));
