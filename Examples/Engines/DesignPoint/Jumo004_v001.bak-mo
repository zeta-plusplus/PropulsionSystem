...
model Jumo004_v001
  ...
  PropulsionSystem.Elements.BasicElements.CmpCharFixed00 Cmp(redeclare package Medium = engineAir, PRdes_paramInput = 3.14, switchDetermine_PR = PropulsionSystem.Types.switches.switchHowToDetVar.param, use_u_eff = false) annotation(
