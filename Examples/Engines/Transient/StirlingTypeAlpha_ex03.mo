...
model StirlingTypeAlpha_ex03
  ...
  Modelica.Mechanics.Rotational.Components.Inertia inertia2(J = 10, w(fixed = false, start = 10)) annotation(
    Placement(visible = true, transformation(origin = {-260, -200}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
  ...
  InteractiveSimulation.Input.AccumulateDigitalInputSignal01 Accumulate(scl = 10, varInit = 500)  annotation(
    Placement(visible = true, transformation(origin = {-350, 90}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  InteractiveSimulation.Input.AccumulateDigitalInputSignal01 Accumulate1(scl = -1.0 * 10, varInit = 0) annotation(
    Placement(visible = true, transformation(origin = {-350, 50}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Math.Add add1 annotation(
    Placement(visible = true, transformation(origin = {-320, 80}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  InteractiveSimulation.Output.dispVarPyConsole02_00 dispVarPyConsole(nVariables = 4, nameVariables = {"time[s]", "THeat[K]", "N[rpm]", "pwr[W]"})  annotation(
    Placement(visible = true, transformation(origin = {-310, -230}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
  ...
  Modelica.Mechanics.Rotational.Sensors.SpeedSensor speedSensor1 annotation(
    Placement(visible = true, transformation(origin = {-200, -210}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
...
equation
  connect(powerSensor1.power, dispVarPyConsole.u_variables[4]) annotation(
    Line(points = {{-222, -210}, {-222, -210}, {-222, -214}, {-244, -214}, {-244, -230}, {-298, -230}, {-298, -230}}, color = {0, 0, 127}));
  connect(to_rpm1.y, dispVarPyConsole.u_variables[3]) annotation(
    Line(points = {{-232, -230}, {-298, -230}, {-298, -230}, {-298, -230}}, color = {0, 0, 127}));
  connect(speedSensor1.w, to_rpm1.u) annotation(
    Line(points = {{-200, -222}, {-200, -222}, {-200, -230}, {-208, -230}, {-208, -230}}, color = {0, 0, 127}));
  connect(speedSensor1.flange, LossRotMech.flange_2) annotation(
    Line(points = {{-200, -200}, {-180, -200}}));
  connect(powerSensor1.flange_a, speedSensor1.flange) annotation(
    Line(points = {{-220, -200}, {-200, -200}}));
  connect(inertia2.flange_a, powerSensor1.flange_b) annotation(
    Line(points = {{-250, -200}, {-240, -200}, {-240, -200}, {-240, -200}}));
  connect(Accumulate1.y, add1.u2) annotation(
    Line(points = {{-339, 50}, {-337, 50}, {-337, 74}, {-332, 74}}, color = {0, 0, 127}));
  connect(Accumulate.y, add1.u1) annotation(
    Line(points = {{-339, 90}, {-337, 90}, {-337, 86}, {-332, 86}}, color = {0, 0, 127}));
  connect(add1.y, hotHeatSource.T) annotation(
    Line(points = {{-309, 80}, {-212, 80}}, color = {0, 0, 127}));
  connect(add1.y, dispVarPyConsole.u_variables[2]) annotation(
    Line(points = {{-309, 80}, {-288, 80}, {-288, -230}, {-298, -230}}, color = {0, 0, 127}));
  connect(timeSignalOut1.y, dispVarPyConsole.u_variables[1]) annotation(
    Line(points = {{-318, -170}, {-288, -170}, {-288, -230}, {-298, -230}, {-298, -230}}, color = {0, 0, 127}));
  connect(keyboardInput1.keyUp, Accumulate.u) annotation(
    Line(points = {{-379, 76}, {-373, 76}, {-373, 90}, {-363, 90}, {-363, 90}}, color = {255, 0, 255}));
  connect(keyboardInput1.keyDown, Accumulate1.u) annotation(
    Line(points = {{-390, 59}, {-390, 59}, {-390, 51}, {-362, 51}, {-362, 51}}, color = {255, 0, 255}));
