...
model Turbojet_ex02
  ...
  InteractiveSimulation.Output.dispVarPyConsole02_00 dispVarPyConsole(nameVariables = {"time[s]"})  annotation(
  ...
  InteractiveSimulation.Utilities.TimeSignalOut timeSignalOut1 annotation(
    Placement(visible = true, transformation(origin = {220, 70}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
...
equation
  connect(timeSignalOut1.y, dispVarPyConsole.u_variables[1]) annotation(
    Line(points = {{232, 70}, {234, 70}, {234, 30}, {238, 30}, {238, 30}}, color = {0, 0, 127}));
