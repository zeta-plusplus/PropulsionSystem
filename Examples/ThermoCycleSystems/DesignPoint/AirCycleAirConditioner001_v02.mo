...
model AirCycleAirConditioner001_v02
  ...
  Modelica.Fluid.Vessels.ClosedVolume volume1(redeclare package Medium = HeatSinkFluid, V = 0.001, nPorts = 2, use_portsData = false) annotation(
    Placement(visible = true, transformation(origin = {39, 61}, extent = {{-7, -7}, {7, 7}}, rotation = 0)));
...
equation
  ...
  connect(HX.port_2_med1, volume1.ports[1]) annotation(
    Line(points = {{20, 52}, {34, 52}, {34, 54}, {39, 54}}, color = {0, 127, 255}));
  connect(volume1.ports[2], boundary1.ports[1]) annotation(
    Line(points = {{39, 54}, {52, 54}, {52, 56}, {60, 56}}, color = {0, 127, 255}, thickness = 0.5));
  connect(ramp_m_flow_cycle.y, boundary4.m_flow_in) annotation(
    Line(points = {{-119, 30}, {-102, 30}, {-102, 27}, {-88, 27}}, color = {0, 0, 127}));
  connect(ramp_THot.y, boundary4.T_in) annotation(
    Line(points = {{-109, 60}, {-104, 60}, {-104, 24}, {-89, 24}}, color = {0, 0, 127}));
  ...
  connect(ramp_THot.y, boundary.T_in) annotation(
    Line(points = {{-109, 60}, {-81.5, 60}, {-81.5, 58}, {-54, 58}}, color = {0, 0, 127}));
  ...
  annotation(
    Diagram(coordinateSystem(extent = {{-140, -100}, {140, 100}}), graphics = {Text(origin = {-20, 65}, extent = {{-14, 3}, {16, -5}}, textString = "outside air"), Text(origin = {38, -69}, extent = {{-14, 3}, {16, -5}}, textString = "room air"), Text(origin = {-18, -27}, extent = {{-14, 3}, {16, -5}}, textString = "exhaust to outside"), Text(origin = {-82, 9}, extent = {{-14, 3}, {14, -3}}, textString = "cycle air")}),
