...
//--- mass conservation ---
  ...
  annotation(
    ...
    Icon(graphics = {Line(origin = {0.39, -10.28}, points = {{-60, -30}, {-60, 60}, {-60, 100}, {60, 100}, {60, 60}, {60, -30}}, thickness = 1.5), Line(origin = {-40, 89}, points = {{0, 9}, {0, -11}}, thickness = 0.75), Line(origin = {-45.6153, 104.79}, points = {{14, -27}, {-2, -27}}, thickness = 0.75), Line(origin = {39.3395, 91}, points = {{0, 9}, {0, -11}}, thickness = 0.75), Line(origin = {34.3847, 107.112}, points = {{14, -27}, {-2, -27}}, thickness = 0.75), Line(origin = {-61, 89.6778}, points = {{-39, 10}, {21, 10}, {21, -12}}, pattern = LinePattern.Dot, thickness = 1), Line(origin = {-51, 99.661}, points = {{151, 0}, {91, 0}, {91, -20}}, pattern = LinePattern.Dot, thickness = 1), Text(origin = {-29, -120}, extent = {{-71, 8}, {129, -6}}, textString = "%name"), Rectangle(origin = {47, -105}, fillColor = {170, 0, 127}, fillPattern = FillPattern.HorizontalCylinder, extent = {{-27, 11}, {53, -3}}), Rectangle(origin = {21, -96}, rotation = 60, fillColor = {170, 0, 127}, fillPattern = FillPattern.HorizontalCylinder, extent = {{-11, 5}, {39, -7}}), Rectangle(origin = {-9, -71}, fillColor = {170, 0, 127}, fillPattern = FillPattern.HorizontalCylinder, extent = {{1, 11}, {45, -1}}), Rectangle(origin = {-22, -94}, rotation = 60, fillColor = {170, 0, 127}, fillPattern = FillPattern.HorizontalCylinder, extent = {{-11, 5}, {37, -9}}), Rectangle(origin = {-73, -105}, fillColor = {170, 0, 127}, fillPattern = FillPattern.HorizontalCylinder, extent = {{-27, 11}, {53, -3}}), Rectangle(origin = {12, -42}, rotation = 105, fillColor = {170, 0, 127}, fillPattern = FillPattern.HorizontalCylinder, extent = {{-27, 7}, {57, -7}}), Rectangle(origin = {-1, 40}, fillColor = {170, 0, 127}, fillPattern = FillPattern.VerticalCylinder, extent = {{-54, -1}, {56, -33}}), Line(origin = {-61.4274, 108.581}, points = {{-17, 0}, {7, 0}}, thickness = 0.75, arrow = {Arrow.None, Arrow.Open}, arrowSize = 4), Line(origin = {71.2041, 108.581}, points = {{-17, 0}, {7, 0}}, thickness = 0.75, arrow = {Arrow.None, Arrow.Open}, arrowSize = 4)}, coordinateSystem(extent = {{-100, -120}, {100, 120}}, initialScale = 0.1)),
