...
partial model TurbineBase02
  ...
  */
  ...
  --------------------------------------------- */
  function fluidOp= PropulsionSystem.Functions.TurbineFunctionPackage.TurbineFluidOperation00(redeclare package inFuncMedium=Medium);
  function mechOp= PropulsionSystem.Functions.TurbineFunctionPackage.TurbineMechOperation00;
