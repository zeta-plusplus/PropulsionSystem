...
model PistonCylinderIdealOttoMV00
  ...
  */
  ...
  /* ---------------------------------------------
      ...
      --------------------------------------------- */
  /**/
  PropulsionSystem.Subelements.OttoCycleIdeal00 OttoCycle(redeclare package Medium = Medium, switch_u_thermoState = PropulsionSystem.Types.switches.switch_input_ThermodynamicState.use_h_for_ThermodynamicState) annotation(
...
equation
  connect(u_fracFuel, OttoCycle.u_fracFuel) annotation(
    Line(points = {{-120, 30}, {-70, 30}, {-70, 26}, {-24, 26}, {-24, 26}}, color = {0, 0, 127}));
...
// distinguish inlet side
  ...
  OttoCycle.u_h_fluidState_1= fluid_1.h;
  ...
  fluid_2.h = OttoCycle.y_h_fluidState_4;
...
//---
  ...
  dH_1_2= m_flow*(fluid_2.h - fluid_1.h);
  dU_1_2= m_flow*(fluid_2.u - fluid_1.u);
  //Q_reject = m_flow * (fluid_2.u - fluid_1.u);
  der(phi) = omega;
  omega * trq = pwr;
